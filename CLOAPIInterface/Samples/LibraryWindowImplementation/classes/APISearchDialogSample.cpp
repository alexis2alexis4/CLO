...
{	
	...
	void APISearchDialogSample::SetSearchMode(SEARCH_ITEM_MODE mode)
	{
		...
		else if (m_SearchMode == SEARCH_MYMODEL)
			lblTitle->setText("My Model");
		else if (m_SearchMode == SEARCH_MYTEST1)
			lblTitle->setText("test1");
	...
	void APISearchDialogSample::SetSearchModeByItemId(const string & itemId)
	{
		...
		else if (qItemId.compare(ITEM_ID_MY_MODEL) == 0)
			SetSearchMode(CLOAPISample::SEARCH_MYMODEL);
		else if (qItemId.compare(ITEM_ID_MY_TEST1) == 0)
			SetSearchMode(CLOAPISample::SEARCH_MYTEST1);
		else
	...
	{
		//UTILITY_API->DisplayMessageBox("Step ohoho");
	...
	{
		//UTILITY_API->DisplayMessageBox("ohoho 2");
	...
	{
		//UTILITY_API->DisplayMessageBox("Step ohoho1");
