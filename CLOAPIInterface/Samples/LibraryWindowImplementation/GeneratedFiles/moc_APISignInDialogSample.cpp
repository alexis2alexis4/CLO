...
struct qt_meta_stringdata_CLOAPISample__APISigninDialogSample_t {
    QByteArrayData data[4];
    char stringdata0[55];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CLOAPISample__APISigninDialogSample_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CLOAPISample__APISigninDialogSample_t qt_meta_stringdata_CLOAPISample__APISigninDialogSample = {
    {
QT_MOC_LITERAL(0, 0, 35), // "CLOAPISample::APISigninDialog..."
...
void CLOAPISample::APISigninDialogSample::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<APISigninDialogSample *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject CLOAPISample::APISigninDialogSample::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_CLOAPISample__APISigninDialogSample.data,
    qt_meta_data_CLOAPISample__APISigninDialogSample,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *CLOAPISample::APISigninDialogSample::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLOAPISample__APISigninDialogSample.stringdata0))
        return static_cast<void*>(this);
    if (!strcmp(_clname, "Ui::DialogSignIn"))
        return static_cast< Ui::DialogSignIn*>(this);
