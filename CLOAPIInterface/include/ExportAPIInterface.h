...
namespace CLOAPI
{
	...
	public:
		...
		/// @param _filePath: output file path
		/// @return Output file path. If an error occurs, return empty string. 
		virtual vector<string> ExportGLTFAsFabric(const string& _filePath) 
		{ 
			vector<string> interface_vector;
			return interface_vector;
		}

		/// @fn ExportGLTFAsFabric(const string& _filePath, const int& index)
		...
		/// @return Output file path. If an error occurs, return empty string. 
		virtual vector<string> ExportGLTFAsFabric(const string& _filePath, const int& index) 
		{ 
			vector<string> interface_vector;
			return interface_vector;
		}
		...
		/// @param index: target fabric index on the object browser to export
		/// @return Output file path. If an error occurs, return empty string. 
		virtual vector<wstring> ExportGLTFAsFabricW(const wstring& _filePath, const int& index) 
		{ 
			vector<wstring> interface_vector;
			return interface_vector;
		}
		...
		/// @param _filePath: output file path
		/// @return Output file path. If an error occurs, return empty string. 
		virtual string ExportPOM(const string& _filePath) { return ""; }

		/// @fn ExportPOM(const wstring& _filePath)
		/// @brief Export POM
		/// @param _filePath: output file path	
		/// @return Output file path. If an error occurs, return empty string. 
		virtual wstring ExportPOMW(const wstring& _filePath) { return L""; }
		...
		virtual vector<string> ExportFBX(const Marvelous::ImportExportOption& _options)
		{
			vector<string> interface_vector;
			return interface_vector;
		}
		...
		/// @param string _filePath : target file path in ASCII
		/// @return Output file paths.
		virtual vector<string> ExportFBX(const string& _filePath, const Marvelous::ImportExportOption& _options)
		{
			vector<string> interface_vector;
			return interface_vector;
		}
		...
		/// @return Output file paths.
		virtual vector<wstring> ExportFBXW(const wstring& _filePath, const Marvelous::ImportExportOption& _options)
		{
			vector<wstring> interface_vector;
			return interface_vector;
		}
