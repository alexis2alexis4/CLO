...
namespace Marvelous
{
	...
	/// @enum ZEPETO_GARMENT_TYPE
	/// @brief Zepeto type to export garment meshes.
	enum ZEPETO_GARMENT_TYPE
	{
		ZEPETO_GARMENT_TOP = 0,		// export garment to top
		ZEPETO_GARMENT_BOTTOM = 1,	// export garment to bottom
		ZEPETO_GARMENT_DRESS = 2,	// export garment to dress (all in one)
		ZEPETO_GARMENT_SHOES = 3,	// export garment to shoes
	};
	...
	public:
		...
		bool bExportForZepeto;
		ZEPETO_GARMENT_TYPE zepetoType;

		std::string m_AuthenticationKeyForAPI; /// For Alvanon to use extended functionalies in CLO API/SDK
		...
		ImportExportOption()
		{
			...
			bExportForZepeto = false;
			zepetoType = ZEPETO_GARMENT_TOP;
			//
			timeScale = 1.0f;
			fps = 30;
